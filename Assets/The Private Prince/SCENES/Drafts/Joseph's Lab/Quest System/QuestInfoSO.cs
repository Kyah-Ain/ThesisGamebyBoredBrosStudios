...
public class QuestInfoSO : ScriptableObject
{
    ...
    [Header("General")]
    public string displayName; // The name of the quest that will be shown to the player

    [Header("Requirements")]
    public int levelRequirements; // The minimum player level required to start the quest
